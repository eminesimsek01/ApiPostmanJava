...
public class Get00 extends SwapiApiBaseUrl {
    /*
        Given
    ...
    public void get11() {
        ...
        assertEquals(swapiApiPojos.getMGLT(),actualDataMap.get("MGLT"));
        assertEquals(swapiApiPojos.getManufacturer(),actualDataMap.get("manufacturer"));
